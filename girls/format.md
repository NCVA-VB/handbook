...
- The deadline to enter these tournaments will be **{{deadline_nonleague_entry}}**. In order for your Non-League registration to be complete, you must register online and submit payment either online or by submitting a check or credit card to the NCVA Office. Please also note there are required club forms to be submitted to the NCVA Office. These can be found on the [forms section of the NCVA website]({{url_ncva_forms}}).
...
Teams will be seeded based on a combination of 2019 team points and finish in 2021 NCVA/USAV Sanctioned events. Teams without 2019 Power League points will initially be seeded after those with points. Any team that believes a seed is significantly incorrect may [submit a seeding appeal.]({{url_powerleague_appeal_form}}) Your written appeal will be considered by the NCVA if your appeal states compelling reasons why your team is mis-seeded and the appropriate calculations for a different seed may occur.

### Initial Seeding
* Teams will be seeded based on their points from the 2019 Power League with a two (2) age group change. For example: NCVA 16-1 will receive NCVA 14-1 Points and based on NCVA 15-1 finish in the 2020 season.
...
### Appeals
* Teams that believe that they are significantly mis-seeded must submit a written appeal to the NCVA Office by the deadline: {{deadline_powerleague_seeding_appeal}}.
...
### Unseeded Teams
For the {{season_year_range}} season these teams will be seeded from the same age group from last season. **Example:** *If your club has a 16-1 team playing in the {{season_year}} season but did not have a 14-1 team in 2019 this 16-1 team would be considered an “unseeded” team*.
...
- Deadline to appeal for Power League Qualifier: **{{deadline_powerleague_seeding_appeal}}**
- Teams who can submit this form are: 
...
### 18s Bid Information 
In {{season_year}}, the 18 Open, 18 National, 18 USA, 18 Liberty, and 18 American Divisions will participate in the Spring USAV {{division}} Junior National Championships (GJNC) event held at the end of April. 

### USAV National Qualifier Bids will be awarded as follows
The {{name_18s_bid}} will offer the following divisions: 18 Open, 18 National, 18 USA, 18 Liberty, and 18 American. Per USAV requirements, this event must be scheduled no later than the third weekend of March. Teams wishing to participate in either the 18 Open, USA, or American divisions, at the end of April, should attend the {{name_18s_bid}} held {{date_18s_bid}} at the {{location_18s_bid}}.

### NCVA Region Bids will be awarded as follows 
National, American, and Freedom Bids will be awarded based on total points accumulated following Power League Region Championships. 
...
[Review League points online.]({{url_league_points}})
